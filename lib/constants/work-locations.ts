...
const WORK_LOCATION_ENTRIES: WorkLocationEntry[] = [
  ...
  { type: WorkLocationType.WEEKEND, name: "Xquang", code: "K1.2TDXQ", block: "Tầng 2" },
  { type: WorkLocationType.WEEKEND, name: "T3", code: "K1.3TD", block: "Tầng 3" },
  { type: WorkLocationType.WEEKEND, name: "3A", code: "K1.301306", block: "Tầng 3" },
  { type: WorkLocationType.WEEKEND, name: "NSTH", code: "K1.3TH", block: "Tầng 3" },
  ...
  { type: WorkLocationType.WEEKEND, name: "T4", code: "K1.4TD", block: "Tầng 4" },
  { type: WorkLocationType.WEEKEND, name: "4A", code: "K1.401406", block: "Tầng 4" },
  { type: WorkLocationType.WEEKEND, name: "4B", code: "K1.407412", block: "Tầng 4" },
  { type: WorkLocationType.WEEKEND, name: "4CD", code: "K1.414417", block: "Tầng 4" },
  { type: WorkLocationType.WEEKEND, name: "4CD", code: "K1.418423", block: "Tầng 4" },
  { type: WorkLocationType.WEEKEND, name: "P430", code: "K1.P430", block: "Tầng 4" },
  { type: WorkLocationType.WEEKEND, name: "T5", code: "K1.5TD", block: "Tầng 5" },
  { type: WorkLocationType.WEEKEND, name: "5A", code: "K1.501506", block: "Tầng 5" },
  { type: WorkLocationType.WEEKEND, name: "5B", code: "K1.507512", block: "Tầng 5" },
  { type: WorkLocationType.WEEKEND, name: "5CD", code: "K1.514517", block: "Tầng 5" },
  { type: WorkLocationType.WEEKEND, name: "5CD", code: "K1.518523", block: "Tầng 5" },
  { type: WorkLocationType.WEEKEND, name: "P530", code: "K1.P530", block: "Tầng 5" },
  { type: WorkLocationType.WEEKEND, name: "T6", code: "K1.6TD", block: "Tầng 6" },
  { type: WorkLocationType.WEEKEND, name: "6A", code: "K1.601606", block: "Tầng 6" },
  { type: WorkLocationType.WEEKEND, name: "6B", code: "K1.607612", block: "Tầng 6" },
  { type: WorkLocationType.WEEKEND, name: "6CD", code: "K1.614617", block: "Tầng 6" },
  { type: WorkLocationType.WEEKEND, name: "6CD", code: "K1.618623", block: "Tầng 6" },
  { type: WorkLocationType.WEEKEND, name: "P630", code: "K1.P630", block: "Tầng 6" },
  { type: WorkLocationType.WEEKEND, name: "Bốt 1", code: "K1.HDV1", block: "Quầy thông tin" },
  { type: WorkLocationType.WEEKEND, name: "Nhà P", code: "K1.HDV2", block: "Tầng 2 nhà P" },
  { type: WorkLocationType.WEEKEND, name: "B1", code: "K1.BTD", block: "Tầng B1" },
  { type: WorkLocationType.WEEKEND, name: "7C", code: "K1.703-706", block: "Tầng 7" },
  { type: WorkLocationType.WEEKEND, name: "7D", code: "K1.707-712", block: "Tầng 7" },
  { type: WorkLocationType.WEEKEND, name: "CS2", code: "CS2", block: "CS2" },
];
