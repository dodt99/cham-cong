...
import { FirestoreSyncIndicator } from "@/components/attendance/firestore-sync-indicator";
...
export function AttendancePageHeader() {
  ...
  return (
    <header className="flex min-w-0 flex-col gap-4 sm:flex-row-reverse sm:items-end sm:justify-between">
      <div className="flex min-w-0 flex-wrap items-center gap-2 sm:flex-row-reverse">
        <CreateWeekDialog
